...
const CAMMY = {
  ...
  moves: {
    ...
    grab: {
      name: '프랑켄슈타이너', startup: 0.13, active: 0.06, recovery: 0.5, isThrow: true,
      damage: 115, range: 1.0, kb: 6.5, kbUp: 5.0, sound: 'whoosh',
      anim: THROW_A, throwDur: 0.55,
    },
    skillN: {
...
const ASUKA = {
  ...
  moves: {
    ...
    grab: {
      name: '어깨 메치기', startup: 0.14, active: 0.06, recovery: 0.5, isThrow: true,
      damage: 130, range: 1.05, kb: 5.0, kbUp: 5.5, sound: 'whoosh',
      anim: THROW_A, throwDur: 0.55,
    },
...
export const CHARACTERS = { chunli: CHUNLI, nina: NINA, cammy: CAMMY, asuka: ASUKA };
